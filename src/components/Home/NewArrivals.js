...
const NewArrivals = ({ showProductDetailPopup, setShowProductDetailPopup }) => {
  ...
  return (
    <section className="md:space-y-5 space-y-3 relative z-0 container mx-auto xl:px-0 md:px-10 px-3 w-full">
